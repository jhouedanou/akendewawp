 ...
 */
//virer la barre de wp
show_admin_bar( false );
add_image_size( 'homepage-thumb', 234, 650, true ); // (cropped)
	...
	if ( !function_exists( 'core_mods' ) ) {
		function core_mods() {
			if ( !is_admin() ) {
				...
				wp_register_script( 'jquery', ( "/wp-content/themes/akendewa/_/js/jquery-1.11.0.min.js" ), true);
